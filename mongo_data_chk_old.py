...
mail_list = ['rohitrgupta@gmail.com','aroteuddhav@gmail.com','aanshul215@gmail.com','karan.info3@gmail.com','hareesh.dx@gmail.com','cbahuman@gmail.com']
#mail_list = ['aanshul215@gmail.com','karan.info3@gmail.com']

actual_coll_list = ["power_k_a","power_k_ch_a","power_k_ch_l","power_k_ch_p1","power_k_ch_p2","power_k_clsrm_ac1","power_k_clsrm_ac2","power_k_clsrm_ac3","power_k_cr_a","power_k_cr_p","power_k_dil_a","power_k_dil_l","power_k_dil_p","power_k_erts_l","power_k_erts_p","power_k_f2_a","power_k_f2_l","power_k_f2_p","power_k_fck_a","power_k_fck_l","power_k_lab_od1","power_k_lab_od2","power_k_lab_od3","power_k_m","power_k_off_a","power_k_off_l","power_k_p","power_k_seil_a","power_k_seil_l","power_k_seil_p","power_k_sr_a","power_k_sr_p","power_k_wc_a","power_k_wc_l","power_k_wc_p","power_k_yc_a","power_k_yc_p","temp_k_201","temp_k_205","temp_k_301","temp_k_305","temp_k_213"]
...
if __name__ == '__main__':
  ...
  try:
    collection_list = list(filter(lambda x: "aravali"  not in x and "dil_l" not in x, mo_con.collection_names()))
    #print "total number of collections checked ",len(collection_list)
    param_dict = get_param_dict(params)
    last_mail_sent_ts = 0
    err_list = []
    for key in collection_list:
      if key not in actual_coll_list:
        continue
      print "%s -- Checked" %(key)
